        ...
        <table>
            ...
            <tr v-for="row in get_rows()" :key="row.id">
                ...
                <!-- <td v-for="col in columns" :key="col">
                    {{col == 'image'? <img :src="row[col]">:row[col]}}
                </td> -->
            </tr>
            </tbody>
        </table>
        <div class="pagination">
            <div class="number" v-for="i in num_pages()" :class="[i == currentPage ? 'active' : '']" :key="i" @click="change_page(i)">
                {{i}}
            </div>
        </div>
    </div>
...
export default {
    ...
    //Creating data relevant to table only
    watch:{
        images(newValue){
            this.rows = newValue.map((img)=> {
                return {
